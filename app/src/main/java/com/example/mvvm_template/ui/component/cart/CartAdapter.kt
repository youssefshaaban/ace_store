...
class CartAdapter(
    val cartProducts: List<Product>, val clickAddCart: (Int, Int) -> Unit,
    val updatePlayerId: (Product) -> Unit
    ...
    inner class SingleRow(var binding: ItemLayoutProductCartBinding) :
        ...
        fun bind(pos: Int) {
            ...
            binding.playerId.setOnClickListener { updatePlayerId(item) }
            binding.playerId.visibility = if (item.productType == 1) View.VISIBLE else View.GONE
