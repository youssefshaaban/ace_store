...
public class VFilePicker {
  ...
  public final static int IMAGE_CAMERA_EXTERNAL = 20;
  private final static int VIDEO_CAMERA_EXTERNAL = 21;

  private final static int ANY_GALLERY = 30;
  public final static int IMAGE_GALLERY = 31;
  public final static int VIDEO_GALLERY = 32;
  ...
  private void fromGallery(Fragment context) {
    ...
    if (requestPermissions(context.getActivity(), requestCode)) {
  ...
  private void fromCamera(Fragment context) {
  ...
  private void fromCameraWithFile(Fragment context) {
    if (pickerType == AUDIO || pickerType == ANY) return;
    ...
    if (requestPermissions(context.getActivity(), requestCode)) {
      ...
      Uri fileURI = VFileUtils.getUriForFile(context.getActivity(), new File(filePath));
  ...
  private void fromFileManager(Fragment context) {
    String setType = "*/*";
    int requestCode = ANY_FILEMANAGER;
  ...
  //public void onRequestPermissions(Fragment context,
  //    int requestCode,
  //    @NonNull String[] permissions,
  //    @NonNull int[] grantResults) {
  //  if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
  ...
  //        || requestCode == VIDEO_GALLERY
  //        || requestCode == ANY_GALLERY) {
  //      fromGallery(context.getContext());
  //    } else if (requestCode == IMAGE_CAMERA || requestCode == VIDEO_CAMERA) {
  //      fromCamera(context);
  //    } else if (requestCode == IMAGE_CAMERA_EXTERNAL || requestCode == VIDEO_CAMERA_EXTERNAL) {
  //      fromCameraWithFile(context);
